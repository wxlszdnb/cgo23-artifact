...
double rlibm_log_estrin_fma(float x) {
  float_x fix, fit;
  fix.f = x;
  int m = 0;
  ...
  if (f < 0x1.5a8f8d28ac42fp-9) {
    ...
    if(f == 0x1.67f6db6db6db7p-10) {
      ...
      // polynomial is y=0x1.fffffffffffd1p-1 x^(1) + -0x1.ffffffa75f811p-2 x^(2) + 0x1.55539dcca455cp-2 x^(3) + -0x1.fb54dd294958dp-3 x^(4)
    ...
    if(f == 0x1.78d3dcb08d3ddp-9){
      ...
      // Polynomial: y=0x1.ffffffff4dc8bp-1 x^(1) + -0x1.fffffaeece64cp-2 x^(2) + 0x1.554e9b388c19ep-2 x^(3) + -0x1.f84d9fdd570dp-3 x^(4)
    ...
    if(f == 0x1.78d3dcb08d3ddp-9){
      y = 0x1.78496eb2b2bc1p-9;
    } else if(f == 0x1.bab0df6b0df6bp-9){
      y = 0x1.b9f1e20cc6841p-9;
    } else if(f == 0x1.e8a1fd1b7af01p-9){
      y = 0x1.e7b9668c47041p-9;
    } else if(f == 0x1.3155555555555p-8){
      y = 0x1.309fcf6432ca1p-8;
      ...
      double coeffs[4]={
			0x1.ffffffff4dc8bp-1,
			-0x1.fffffaeece64cp-2,
			0x1.554e9b388c19ep-2,
			-0x1.f84d9fdd570dp-3
      };
      // Polynomial: y=0x1.ffffffff4dc8bp-1 x^(1) + -0x1.fffffaeece64cp-2 x^(2) + 0x1.554e9b388c19ep-2 x^(3) + -0x1.f84d9fdd570dp-3 x^(4)
